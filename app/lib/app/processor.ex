defmodule App.Processor do
  ...
  def run(file_path, options \\ []) do
    max_value_risc_card_use = Keyword.get(options, :max_value_risc, 100000)
    ...
    # Processa o arquivo usando Stream.run() para enviar resultados imediatamente ao agregador
    file_path
